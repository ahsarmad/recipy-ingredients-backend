...
path_to_datasets = path_to_server
# path_to_recipe_data = os.path.join(path_to_server, "recipe_data")
path_to_recipe_data = path_to_server
path_to_central_recipe_data = os.path.join(
    path_to_recipe_data, "central_recipe_data.csv")

path_to_ingredient_data = os.path.join(
    path_to_datasets, "Manually Combined Dataset.csv")
